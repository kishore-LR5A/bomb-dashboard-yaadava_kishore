  ...
  return (
    <div className="mx-auto mt-5 flex flex-col bg-[#202543] bg-opacity-50 space-y-1 w-[1048px] h-[400px] justify-center items-start rounded-md p-[22px]">
      ...
      <div className="flex flex-col">
        {/* upper */}
        <BombFarmsComponent title="BOMB-BTCB" pic1={bombbitLP} pic2={bshares} bankContract='BombBtcbLPBShareRewardPool' />
        <hr className="border border-b-[0.5px] text-[#C3C5CB] w-[1000px] mt-2" />
        {/* lower */}
        <BombFarmsComponent title="BSHARE-BNB" pic1={bsharebnbLP} pic2={bshares} bankContract='BshareBnbLPBShareRewardPool' />
        {/* <BombFarmsBnb /> */}
      </div>
    </div>
  );
